    ...
    <section id="hero" className="relative hero-dots" ref={heroRef}>
      ...
      <div className="hero-stage mx-auto max-w-7xl px-5 md:px-10 pt-8 md:pt-14 pb-14 md:pb-20 relative flex items-center">
        <div className="max-w-3xl relative z-10 w-full">
          ...
          {/* Location badge */}
          <div
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-ink/8 shadow-soft text-[0.72rem] tracking-[0.18em] font-semibold text-ink-soft uppercase"
            data-line=""
          >
          ...
          {/* Headline */}
          <h1
            className="font-display italic text-ink text-balance mt-8 md:mt-10"
            style={{ fontSize: 'clamp(2rem, 4.6vw, 4rem)', lineHeight: 1.08, letterSpacing: '-0.01em', fontWeight: 500 }}
          >
          ...
          {/* Attribution */}
          <p className="mt-5 md:mt-6 font-script text-xl md:text-2xl text-ink-mute" data-line="">
            &mdash; Swami Vivekananda
          </p>

          {/* Sub-copy */}
          <p
            className="mt-7 md:mt-9 text-base md:text-lg text-ink-soft max-w-xl leading-relaxed text-balance"
            data-line=""
          >
            <span className="text-ink font-semibold">The Oxford Academy</span> is Theni&rsquo;s
            home for English, excellence and the future &mdash; a place built by a teacher, for
            everyone who has something to say but hasn&rsquo;t found the words yet.
          </p>

          {/* CTAs */}
          <div className="mt-7 md:mt-9 flex flex-wrap items-center gap-3 relative z-30" data-line="">
            <a href="#courses" className="btn btn-magenta">
              Explore courses
              <ArrowRight className="w-4 h-4" aria-hidden="true" />
            </a>
            <a href="#contact" className="btn btn-ink-outline">
              Book a free demo
            </a>
          </div>
